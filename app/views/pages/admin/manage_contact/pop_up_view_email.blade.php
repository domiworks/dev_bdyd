<div class="modal fade pop_up_view_email" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					...
					<div class="row">
						<div class="g-sm-12"><!-- g-sm-5 -->
							...
							<div class="form-group">
								<label class="g-sm-4 control-label">Full Name</label>
								<div class="g-sm-6">
									<p class="form-control-static" id='message_name'>
										Nama Seseorang
									</p>
								</div> 
							</div>  
							<div class="form-group">
								<label class="g-sm-4 control-label">Date</label>
								<div class="g-sm-6">
									<p class="form-control-static" id='message_date'>
										2015-01-23 21:02:44
									</p>
								</div> 
							</div>   
							<div class="form-group">
								...
								<div class="g-sm-6">
									<p class="form-control-static" id='message_email'>
										gmail@seseorang.com
									</p>
								</div> 
							</div> 
							<div class="form-group">
								...
								<div class="g-sm-6">
									<p class="form-control-static" id='message_phone'>
										0874560435
									</p>
								</div> 
							</div>   
							<div class="form-group">
								<label class="g-sm-4 control-label">Subject</label>
								<div class="g-sm-6">
									<p class="form-control-static" id='message_subject'>
										Administrative Collaboration
									</p>
								</div> 
							</div>   
							<div class="form-group">
								<label class="g-sm-4 control-label">Message</label>
								<div class="g-sm-6">
									<p class="form-control-static" id='message_content'>
