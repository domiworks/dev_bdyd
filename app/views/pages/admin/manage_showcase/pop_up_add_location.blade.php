<div class="modal fade pop_up_add_location" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<div class="modal-content">
			...
			<form class="form-horizontal" role="form">
					...
					<div class="row">
						<div class="g-sm-12"><!-- g-sm-5 -->
							...
							<div class="form-group">
								...
								<div class="g-sm-5">
									<select id="f_input_showcase" class="form-control" style="width: 140px;float: left;">
							...
							<div class="form-group">
								...
								<div class="g-sm-5">
									...
									<input id="f_input_venue_name" type="text" class="form-control" value="">	
								</div> 
							</div> 
							<div class="form-group">
								...
								<div class="g-sm-5">
									<input type="hidden" value="">
									<input id="f_input_city_name" type="text" class="form-control" value="">	
								</div> 
							</div> 
						</div> 
					</div> 
				...
				<div class="modal-footer">
					<button id="f_add_new_location" type="button" class="btn btn-success" data-dismiss="modal">Add</button>
