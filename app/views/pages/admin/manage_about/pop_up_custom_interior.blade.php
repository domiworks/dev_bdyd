<div class="modal fade pop_up_custom_interior" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Custom Furniture Service Description</h4>
			...
			<form class="form-horizontal" role="form">
					...
					<div class="row">
						<div class="g-sm-12"><!-- g-sm-5 -->
							...
							<div class="form-group">
								<div class="g-sm-12">
									<textarea class="form-control f_custom_furniture_txt_area">{{$custom}}</textarea>
								</div>

								<div class="g-sm-12">
									<button type="button" class="btn btn-success custom_furniture_save" style="margin-left: auto; margin-right: auto; display: block;">Save</button>
								</div>
							</div>
				...
				<div class="modal-footer">
					<button type="button" id="cancelAddButton" class="btn btn-default" data-dismiss="modal">Close</button>
				</div>
			</form>
		</div>
	</div>
