		...
		<div class="modal-content">
			...
			<div class="form-horizontal" role="form">
						...
						<div class="g-sm-12"><!-- g-sm-5 -->
							...
							<div class="form-group">
								...
								<div class="g-sm-6">
									...
									<input id="f_input_catname" type="text" class="form-control" value="">	
								</div> 
							</div> 
						</div> 
					</div> 
				...
				<div class="modal-footer">
					<button id="f_add_new_category" type="button" class="btn btn-success" data-dismiss="modal">Add</button>
