<div class="modal fade pop_up_edit_user" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			...
			<form class="form-horizontal" role="form">
				<div class="modal-body"> 
					<div class="form-group">
						<label class="g-sm-3 control-label">New Username</label>
						<div class="g-sm-6">
							<input type="text" class="form-control" id="f_get_edit_username">
						</div>
					</div>
					<div class="form-group">
						<label class="g-sm-3 control-label">Password</label>
						<div class="g-sm-6">
							<input type="password" class="form-control" id="f_get_edit_password">
						</div>
						<p class="g-sm-3 form-control-static bg-danger text-danger">
							Wrong Password
						</p>
					</div>
				</div>
				<div class="modal-footer">
					...
					<button id="f_add_edit_new_user" type="button" class="btn btn-success" data-dismiss="modal">Edit</button>
