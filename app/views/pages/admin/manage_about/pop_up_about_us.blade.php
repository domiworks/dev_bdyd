<div class="modal fade pop_up_about_us" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">About Us Description</h4>
					...
					<div class="row">
						<div class="g-sm-12"><!-- g-sm-5 -->
							...
							<div class="form-group">
								<div class="g-sm-12">
									<textarea class="form-control f_about_us_txt_area">{{$about_us}}</textarea>
								</div>

								<div class="g-sm-12">
									<button type="button" class="btn btn-success save_about_us" style="margin-left: auto; margin-right: auto; display: block;">Save</button>
								</div>
							</div>
