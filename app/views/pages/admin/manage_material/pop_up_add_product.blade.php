		...
		<div class="modal-content">
			...
			<form class="form-horizontal" role="form">
						...
						<div class="g-sm-12"><!-- g-sm-5 -->
							...
							<div class="form-group">
								...
								<div class="g-sm-6">
									...
									<input id="f_input_prodname" type="text" class="form-control" value="">	
								</div> 
							</div> 
							<div class="form-group">
								<label class="g-sm-4 control-label">Category Name</label>
								<div class="g-sm-6">
									<p class="form-control-static" id='current_category_name'>
										Current Category
									</p>
								</div> 
							</div>  
							<div class="form-group">
								...
								<div class="g-sm-6">
									...
									<input type="file" class="f_pic_identity" value="" style="float: left; margin-left: 15px" accept="image/*">	
				...
				<div class="modal-footer">
					<button id="f_add_new_product" type="button" class="btn btn-success" data-dismiss="modal">Add</button>
